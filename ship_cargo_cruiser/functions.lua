...
function ship_cargo.update_formspec(pos, data, loc, ready, message)
...
function ship_cargo.engine_do_jump(pos, dest, size, jump_callback, dest_offset)
...
function ship_cargo.engine_jump_activate(pos, dest, size)
    local pos1 = vector.subtract(pos, {
        x = size.w,
        y = size.h,
        z = size.l
...
function ship_cargo.get_jump_dest(pos, offset, size)
    local pos1 = vector.subtract(pos, {
        x = size.w,
        y = size.h,
        z = size.l
...
function ship_cargo.get_jumpdrive(pos, size)
    local pos1 = vector.subtract(pos, {
        x = size.w,
        y = size.h,
        z = size.l
...
function ship_cargo.get_protector(pos, size)
    local pos1 = vector.subtract(pos, {
        x = size.w,
        y = size.h,
        z = size.l

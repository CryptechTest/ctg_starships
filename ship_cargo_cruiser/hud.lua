local S = ship_cargo.protector.intllib
    ...
    minetest.register_globalstep(function(dtime)
        ...
        for _, player in pairs(minetest.get_connected_players()) do
            ...
            local protectors = minetest.find_nodes_in_area({
                x = pos.x - ship_cargo.protector.size.w,
                y = pos.y - ship_cargo.protector.size.h,
                z = pos.z - ship_cargo.protector.size.l
            }, {
                x = pos.x + ship_cargo.protector.size.w,
                y = pos.y + ship_cargo.protector.size.h,
                z = pos.z + ship_cargo.protector.size.l
            }, {"ship_cargo:jump_drive"})

local S = ship_battle_cruiser_small.protector.intllib
    ...
    minetest.register_globalstep(function(dtime)
        ...
        for _, player in pairs(minetest.get_connected_players()) do
            ...
            local protectors = minetest.find_nodes_in_area({
                x = pos.x - ship_battle_cruiser_small.protector.size.w,
                y = pos.y - ship_battle_cruiser_small.protector.size.h,
                z = pos.z - ship_battle_cruiser_small.protector.size.l
            }, {
                x = pos.x + ship_battle_cruiser_small.protector.size.w,
                y = pos.y + ship_battle_cruiser_small.protector.size.h,
                z = pos.z + ship_battle_cruiser_small.protector.size.l
            }, {"ship_battle_cruiser_small:jump_drive"})
